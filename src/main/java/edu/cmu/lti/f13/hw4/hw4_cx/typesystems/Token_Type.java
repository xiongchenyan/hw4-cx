...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Token");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Token");
  ...
  public int getFrequency(int addr) {
      ...
      jcas.throwFeatMissing("frequency", "edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Token");
