...
public class Document_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Document");
  ...
  public int getRelevanceValue(int addr) {
      ...
      jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Document");
  ...
  public int getQueryID(int addr) {
      ...
      jcas.throwFeatMissing("queryID", "edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Document");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Document");
  ...
  public int getTokenList(int addr) {
      ...
      jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f13.hw4.hw4_cx.typesystems.Document");
